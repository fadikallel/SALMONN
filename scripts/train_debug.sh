...
DATASET=/mnt/bn/tiktok-mm-4/aiic/users/tangchangli/preprocess_dataset/vAnnt_merge.json
MODEL=hdfs://harunava/home/byte_malia_gcp_aiic/user/liyixuan/model/Qwen2.5-VL-7B-Instruct
MODEL_BASE=hdfs://harunava/home/byte_malia_gcp_aiic/user/liyixuan/model/Qwen2.5-VL-7B-Instruct
LR=2e-5
BS=1
ACCUM_STEPS=1
...
torchrun --nproc_per_node=${ARNOLD_WORKER_GPU} --nnodes="${ARNOLD_WORKER_NUM}" --node_rank="${ARNOLD_ID}" --master_addr=127.0.0.1 --master_port=12396 \
