...
class ALLM(nn.Module):
    ...
    def __init__(
        ...
        self.speech_llama_proj_model = nn.Linear(self.speech_encoder.config.d_model, self.llama_model.config.hidden_size)
    ...
    def _encode_auditory_feature(self, speech_embeds):
        with self.maybe_autocast():
            ...
            speech_embeds = self.speech_llama_proj_model(speech_embeds)
